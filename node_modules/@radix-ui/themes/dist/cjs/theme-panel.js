                ...
                React.createElement(index_1.Box, { grow: "1", p: "5", position: "relative" },
                    ...
                    React.createElement(index_1.Grid, { columns: "10", gap: "2", mt: "3", role: "group", "aria-labelledby": "accent-color-title" }, index_1.themeAccentColorsOrdered.map((color) => (React.createElement("label", { key: color, className: "rt-ThemePanelSwatch", style: { backgroundColor: `var(--${color}-9)` } },
                        React.createElement(index_1.Tooltip, { content: `${upperFirst(color)}${accentColor === 'gray' && resolvedGrayColor !== 'gray'
                                ...
                                : ''}` },
                            React.createElement("input", { type: "radio", name: "accentColor", value: color, checked: accentColor === color, onChange: (event) => onAccentColorChange(event.target.value) })))))),
                    ...
                    React.createElement(index_1.Grid, { columns: "10", gap: "2", mt: "3", role: "group", "aria-labelledby": "gray-color-title" }, ['auto', 'gray', ...index_1.radixGrayScalesDesaturated].map((gray) => (React.createElement(index_1.Flex, { key: gray, asChild: true, align: "center", justify: "center" },
                        React.createElement("label", { className: "rt-ThemePanelSwatch", style: {
                            ...
                            React.createElement(index_1.Tooltip, { content: `${upperFirst(gray)}${gray === 'auto' ? ` (${upperFirst(autoMatchedGray)})` : ''}` },
                                React.createElement("input", { type: "radio", name: "grayColor", value: gray, checked: grayColor === gray, onChange: (event) => onGrayColorChange(event.target.value) }))))))),
                    ...
                    React.createElement(index_1.Grid, { columns: "2", gap: "2", mt: "3", role: "group", "aria-labelledby": "appearance-title" }, ['light', 'dark'].map((value) => (React.createElement("label", { key: value, className: "rt-ThemePanelRadioCard" },
                        React.createElement("input", { type: "radio", name: "appearance", value: value, checked: resolvedAppearance === value, 
                    ...
                    React.createElement(index_1.Grid, { columns: "5", gap: "2", mt: "3", role: "group", "aria-labelledby": "radius-title" }, index_1.themePropDefs.radius.values.map((value) => (React.createElement(index_1.Flex, { key: value, direction: "column", align: "center" },
                        React.createElement("label", { className: "rt-ThemePanelRadioCard" },
                            React.createElement("input", { type: "radio", name: "radius", id: `theme-panel-radius-${value}`, value: value, checked: radius === value, onChange: (event) => onRadiusChange(event.target.value) }),
                    ...
                    React.createElement(index_1.Grid, { columns: "5", gap: "2", mt: "3", role: "group", "aria-labelledby": "scaling-title" }, index_1.themePropDefs.scaling.values.map((value) => (React.createElement("label", { key: value, className: "rt-ThemePanelRadioCard" },
                        React.createElement("input", { type: "radio", name: "scaling", value: value, checked: scaling === value, onChange: (event) => onScalingChange(event.target.value) }),
                    ...
                    React.createElement(index_1.Grid, { columns: "2", gap: "2", mt: "3", role: "group", "aria-labelledby": "panel-background-title" }, index_1.themePropDefs.panelBackground.values.map((value) => (React.createElement("label", { key: value, className: "rt-ThemePanelRadioCard" },
                        React.createElement("input", { type: "radio", name: "panelBackground", value: value, checked: panelBackground === value, onChange: (event) => onPanelBackgroundChange(event.target.value) }),
                        React.createElement(index_1.Flex, { align: "center", justify: "center", height: "6", gap: "2" },
...
function Label(props) {
    return (React.createElement(index_1.Text, { ...props, size: "1", color: "gray", asChild: true },
