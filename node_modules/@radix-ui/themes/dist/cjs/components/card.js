...
const Card = React.forwardRef((props, forwardedRef) => {
    ...
    return (React.createElement(Comp, { ref: forwardedRef, ...cardProps, className: (0, classnames_1.default)('rt-reset-a', 'rt-reset-button', 'rt-Card', className, (0, helpers_1.withBreakpoints)(size, 'rt-r-size'), `rt-variant-${variant}`, (0, helpers_1.withMarginProps)(marginProps)) }, asChild ? getChild() : React.createElement("div", { className: "rt-CardInner" }, children)));
});
exports.Card = Card;
