    ...
    return (React.createElement(TooltipPrimitive.Root, { ...rootProps },
        ...
        React.createElement(TooltipPrimitive.Portal, { container: container, forceMount: forceMount },
            React.createElement(theme_1.Theme, { asChild: true },
                React.createElement(TooltipPrimitive.Content, { sideOffset: 4, collisionPadding: 10, ...tooltipContentProps, ref: forwardedRef, className: (0, classnames_1.default)('rt-TooltipContent', className, { 'rt-multiline': multiline }) },
