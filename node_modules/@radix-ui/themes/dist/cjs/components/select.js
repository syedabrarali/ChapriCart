...
const SelectTrigger = React.forwardRef((props, forwardedRef) => {
    ...
    return (React.createElement(SelectPrimitive.Trigger, { asChild: true },
        React.createElement("button", { "data-accent-color": color, "data-radius": radius, ...triggerProps, ref: forwardedRef, className: (0, classnames_1.default)('rt-reset-button', 'rt-SelectTrigger', className, (0, helpers_1.withBreakpoints)(size, 'rt-r-size'), `rt-variant-${variant}`, (0, helpers_1.withMarginProps)(marginProps)) },
