...
const TabsTrigger = React.forwardRef((props, forwardedRef) => {
    ...
    return (React.createElement(TabsPrimitive.Trigger, { ...triggerProps, ref: forwardedRef, className: (0, classnames_1.default)('rt-reset-button', 'rt-TabsTrigger', className) },
