...
const DropdownMenuItem = React.forwardRef((props, forwardedRef) => {
    ...
    return (React.createElement(DropdownMenuPrimitive.Item, { "data-accent-color": color, ...itemProps, ref: forwardedRef, className: (0, classnames_1.default)('rt-reset-a', 'rt-BaseMenuItem', 'rt-DropdownMenuItem', className) },
