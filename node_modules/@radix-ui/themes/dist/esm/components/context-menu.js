...
const ContextMenuItem = React.forwardRef((props, forwardedRef) => {
    ...
    return (React.createElement(ContextMenuPrimitive.Item, { "data-accent-color": color, ...itemProps, ref: forwardedRef, className: classNames('rt-reset-a', 'rt-BaseMenuItem', 'rt-ContextMenuItem', className) },
