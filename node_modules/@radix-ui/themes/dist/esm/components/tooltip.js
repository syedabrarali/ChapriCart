    ...
    return (React.createElement(TooltipPrimitive.Root, { ...rootProps },
        ...
        React.createElement(TooltipPrimitive.Portal, { container: container, forceMount: forceMount },
            React.createElement(Theme, { asChild: true },
                React.createElement(TooltipPrimitive.Content, { sideOffset: 4, collisionPadding: 10, ...tooltipContentProps, ref: forwardedRef, className: classNames('rt-TooltipContent', className, { 'rt-multiline': multiline }) },
