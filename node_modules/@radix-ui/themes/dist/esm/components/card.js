...
const Card = React.forwardRef((props, forwardedRef) => {
    ...
    return (React.createElement(Comp, { ref: forwardedRef, ...cardProps, className: classNames('rt-reset-a', 'rt-reset-button', 'rt-Card', className, withBreakpoints(size, 'rt-r-size'), `rt-variant-${variant}`, withMarginProps(marginProps)) }, asChild ? getChild() : React.createElement("div", { className: "rt-CardInner" }, children)));
});
