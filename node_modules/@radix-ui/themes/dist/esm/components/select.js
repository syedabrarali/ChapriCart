...
const SelectTrigger = React.forwardRef((props, forwardedRef) => {
    ...
    return (React.createElement(SelectPrimitive.Trigger, { asChild: true },
        React.createElement("button", { "data-accent-color": color, "data-radius": radius, ...triggerProps, ref: forwardedRef, className: classNames('rt-reset-button', 'rt-SelectTrigger', className, withBreakpoints(size, 'rt-r-size'), `rt-variant-${variant}`, withMarginProps(marginProps)) },
...
const SelectContent = React.forwardRef((props, forwardedRef) => {
    ...
    return (React.createElement(SelectPrimitive.Portal, { container: container },
        React.createElement(Theme, { asChild: true },
            React.createElement(SelectPrimitive.Content, { "data-accent-color": resolvedColor, sideOffset: 4, align: "center", ...contentProps, ref: forwardedRef, className: classNames({ 'rt-PopperContent': contentProps.position === 'popper' }, 'rt-SelectContent', className, withBreakpoints(size, 'rt-r-size'), `rt-variant-${variant}`, { 'rt-high-contrast': highContrast }) },
                React.createElement(ScrollAreaPrimitive.Root, { type: "auto", className: "rt-ScrollAreaRoot" },
                    ...
                    React.createElement(ScrollAreaPrimitive.Scrollbar, { className: "rt-ScrollAreaScrollbar size-1", orientation: "vertical" },
