...
const DropdownMenuItem = React.forwardRef((props, forwardedRef) => {
    ...
    return (React.createElement(DropdownMenuPrimitive.Item, { "data-accent-color": color, ...itemProps, ref: forwardedRef, className: classNames('rt-reset-a', 'rt-BaseMenuItem', 'rt-DropdownMenuItem', className) },
...
const DropdownMenuSubContent = React.forwardRef((props, forwardedRef) => {
    ...
    return (React.createElement(DropdownMenuPrimitive.Portal, { container: container, forceMount: forceMount },
        React.createElement(Theme, { asChild: true },
            React.createElement(DropdownMenuPrimitive.SubContent, { "data-accent-color": color, alignOffset: -Number(size) * 4, collisionPadding: 10, ...subContentProps, ref: forwardedRef, className: classNames('rt-PopperContent', 'rt-BaseMenuContent', 'rt-BaseMenuSubContent', 'rt-DropdownMenuContent', 'rt-DropdownMenuSubContent', className, withBreakpoints(size, 'rt-r-size'), `rt-variant-${variant}`, { 'rt-high-contrast': highContrast }) },
                React.createElement(ScrollArea, { type: "auto" },
